...
const nftsMetadata = [
  ...
  },
  {
    ...
    external_url:
      "https://ipfs.io/ipfs/QmP6yXPPgfqY9QL44JqAZXC2KY3UFEbpogexmwpFXjrnay/", // <-- this can link to a page for the specific file too
    image:
      "https://ipfs.io/ipfs/QmP6yXPPgfqY9QL44JqAZXC2KY3UFEbpogexmwpFXjrnay/",
    name: "macarrons",
    attributes: [
      {
        trait_type: "BackgroundColor",
