...
mod YourCollectible {
    ...
    fn constructor(ref self: ContractState, owner: ContractAddress) {
        ...
        let base_uri: ByteArray = "https://ipfs.io/ipfs/"; // -> base uri
    ...
    impl YourCollectibleImpl of IYourCollectible<ContractState> {
        fn mint_item(ref self: ContractState, recipient: ContractAddress, uri: ByteArray) -> u256 {
            ...
            self.token_id_counter.increment();// increment the token id
            ...
            //mintea la primera imagen con el token id especifico
            self.erc721.mint(recipient, token_id);

            //guarda que esa imagen tenga ese token id en el
