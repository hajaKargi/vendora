...
exports.updateQuestionValidation = exports.createQuestionValidation = void 0;
...
exports.createQuestionValidation = {
    body: joi_1.default.object({
        content: joi_1.default.object({
            ...
            wrongAnswers: joi_1.default.array().items(joi_1.default.string()).min(1).required(),
        ...
        metadata: joi_1.default.object({
            ...
            type: joi_1.default.string().valid('multiple-choice').required()
        }).required(),
...
exports.updateQuestionValidation = {
    body: joi_1.default.object({
        content: joi_1.default.object({
            ...
            correctAnswer: joi_1.default.string(),
            wrongAnswers: joi_1.default.array().items(joi_1.default.string()).min(1),
        ...
        metadata: joi_1.default.object({
            ...
            type: joi_1.default.string().valid('multiple-choice')
        }),
        gameMetadata: joi_1.default.object({
